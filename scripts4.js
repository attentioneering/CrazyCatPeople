//welcome to my latest installment of Art Brut. May it offend your senses!
//joking aside, the controls are a little janky as I didn't really have the time to finesse anything properly. At least it works..kinda.
//it was a pleasure learning from you all and I look forward to hearing your feedback soonish!
                     ...
                     $.ajax({ 
                        ...
                        success: function(pictures) {
                            ...
                            const urlMap = (pictures.map((cat)=>{
                                ...
                                const adoptText = (`PSSSSST! If these cats aren't enough for you, there are always a beautiful barrage of kitties awaiting adoption! Find a new furbaby in need of a good home courtesy of PetFinder!`)
...
$('#button2').on('click', function(event){
     ...
     $.ajax({
        ...
        crossDomain: true,
        data: {
            //location:`${userLocation}` <-this doesn't seem to work, so the adoptable cats are pulled randomly instead of being local. Postal code doesn't seem to work well either.
            count:1,
            }
        }).done(function(data) {
